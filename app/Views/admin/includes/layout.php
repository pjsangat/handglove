...
<body>
    ...
    <script src="http://handglove.local/assets/dist/js/plugins/popper.min.js" ></script>
    <script src="http://handglove.local/assets/dist/js/plugins/bootstrap-4.5.2/bootstrap.min.js" ></script>
    <script src="http://handglove.local/assets/dist/js/components/global.min.js" ></script>
    <script src="http://handglove.local/assets/dist/js/plugins/toastr.min.js" ></script>
    <script src="http://handglove.local/assets/dist/js/components/navigation_bar.min.js" ></script>
