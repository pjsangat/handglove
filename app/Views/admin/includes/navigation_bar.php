            ...
            <div class="inner-container">
                <div class="logo-box">
                    <a href="<?php echo base_url(); ?>" class="nav-logo">
                        ...
                        <div style="line-height: 1;">Handglove<br><small style="font-size: 60%">Admin</small></div>
                    </a>
                ...
                <div class="main-nav__main-navigation">
                    ...
                    <?php  if( session()->get('isAdminLoggedIn') == 1 ){ ?>
                        <ul class="main-nav__navigation-box" id="user_menu">
                            ...
                            <li class="dropdown">
                                <a href="#">
                                    ...
                                    <div class="user-name">
                                        <div><strong>Hi, <?php echo session()->get('admin_name');?></strong></div>
                                    </div>
                                </a>
                                <ul>
                                    <li><a href="<?php echo base_url('facility'); ?>">Account Settings</a></li>
