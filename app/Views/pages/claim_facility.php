<div id="claim-facility" class="main-pages page-section">
    <div class="container">
        <div class="row align-items-center mb-5 hero-section">
            <div class="col-md-7">
                <h1 class="hero-title"><span class="text-blue">Stand out</span> with a free Business Profile</h1>
                ...
                <div class="row steps-row mt-5">
                    <div class="col-md-4 mb-4">
                        <div class="step-card">
                            <span class="step-num text-blue">1</span>
                            <h5>Claim</h5>
                            <p class="small text-muted">Create a Business Profile, or manage an existing profile on Search and Maps</p>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="step-card">
                            <span class="step-num text-blue">2</span>
                            <h5>Personalise</h5>
                            <p class="small text-muted">Add hours, photos, and other details and get discovered by customers near you</p>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="step-card">
                            <span class="step-num text-blue">3</span>
                            <h5>Manage</h5>
                            <p class="small text-muted">Share updates, respond to reviews, and connect with customers on Google</p>
                        </div>
                    </div>
                </div>
            </div>
