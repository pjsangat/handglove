...
(new WOW).init();var JOBS={init:function(){JOBS.events.init()},events:{init:function(){JOBS.events.applyNow()},applyNow:function(){$(".apply-now").click(function(){var i=$(this).data("shift_id"),t=$(this).parent().parent(),a=$(this);$.ajax({url:GLOBAL_BASE_URL+"jobs/apply",data:{shiftID:i},type:"POST",dataType:"json",success:function(i){i=1==i.success?'<div id="requestConfirmation"><div class="p-3 mb-2 bg-success text-white">'+i.message+"</div></div>":'<div id="requestConfirmation"><div class="p-3 mb-2 bg-danger text-white">'+i.message+"</div></div>",$(t).prepend(i),a.remove(),setTimeout(function(){$("#requestConfirmation").html(""),$("#requestConfirmation").remove()},5e3)}})}),$(".apply").click(function(){var i=$(this).data("shift_id");$("#submit-application").attr("data-shift_id",i),$("#submit-application").data("shift_id",i),$("#shift_id_field").val(i),$("#applicantsModal").modal("show")}),$("#submit-application").click(function(i){i.preventDefault();i=new FormData($("#formApplication")[0]);$(this).data("shift_id");console.info(i),$.ajax({url:GLOBAL_BASE_URL+"jobs/apply_register",type:"POST",data:i,processData:!1,contentType:!1,dataType:"json",success:function(i){var a;1==i.success?(a='<div class="p-3 mb-2 bg-success text-white">'+i.message+"</div>",$("#applicationConfirmation").html(a),$("#shift_id_field").val(""),$("#submit-application").removeAttr("data-shift_id"),$("#formApplication").remove()):(a='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',a+="<ul>",$.each(i.message,function(i,t){a+="<li>"+t+"</li>"}),a+="</ul></div>",$("#applicationConfirmation").html(a))}})})}},build:{}};$(document).ready(JOBS.init);