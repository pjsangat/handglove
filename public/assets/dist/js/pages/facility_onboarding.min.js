...
(new WOW).init();var FACILITY_ONBOARDING={shiftDate:{},init:function(){FACILITY_ONBOARDING.build.table(),FACILITY_ONBOARDING.events.init()},events:{init:function(){FACILITY_ONBOARDING.events.updateFile(),FACILITY_ONBOARDING.events.submitFile(),FACILITY_ONBOARDING.events.submitSettings()},submitFile:function(){$("#submitOnboarding").click(function(){var e=new FormData($("#fileAddForm")[0]);$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/update",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){var i;1==e.success?(i='<div class="p-3 mb-2 bg-success text-white">'+e.message+"</div>",$("#formConfirmation").html(i),setTimeout(function(){$("#formConfirmation").html("")},5e3),$("#updateFileModal").modal("hide"),$("#files_table").DataTable().ajax.reload(),$("#fileAddForm")[0].reset()):(i='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',i+="<ul>",$.each(e.message,function(e,a){i+="<li>"+a+"</li>"}),i+="</ul></div>",$("#validationErrors").html(i))}})})},submitSettings:function(){$("#submitOnboardingSettings").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/update_settings",type:"POST",data:$("#onboardingSettingsForm").serialize(),dataType:"json",success:function(e){var i;1==e.success?(i='<div class="p-3 mb-2 bg-success text-white">'+e.message+"</div>",$("#settingConfirmation").html(i),setTimeout(function(){$("#settingConfirmation").html("")},5e3)):(i='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',i+="<ul>",$.each(e.message,function(e,a){i+="<li>"+a+"</li>"}),i+="</ul></div>",$("#settingValidationErrors").html(i))}})})},updateFile:function(){$("#files_table").on("click",".update-onboarding",function(){var e=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/edit",type:"POST",data:{onboardingID:e},dataType:"json",success:function(e){1==e.success&&($("#fileAddForm")[0].reset(),$("#updateFileModal").find("#name").val(e.onboarding.name),$("#updateFileModal").find("#name").selectpicker("refresh"),$("#updateFileModal").find("#description").val(e.onboarding.description),$("#updateFileModal").find("#youtube_link").val(e.onboarding.youtube_link),$("#updateFileModal").find("#command").val(e.onboarding.command),$("#onboardingID").val(e.onboarding.id),$("#updateFileModal").modal("show"))}})})}},build:{table:function(){$("#files_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/onboarding/list",type:"POST"},columns:[{data:"name"},{data:"pdf"},{data:"youtube"},{data:"action"}]})}}};$(document).ready(FACILITY_ONBOARDING.init);