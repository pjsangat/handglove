...
(new WOW).init();var FACILITY_ONBOARDING={shiftDate:{},init:function(){FACILITY_ONBOARDING.build.table(),FACILITY_ONBOARDING.events.init()},events:{init:function(){FACILITY_ONBOARDING.events.insertFile(),FACILITY_ONBOARDING.events.updateFile(),FACILITY_ONBOARDING.events.submitFile(),FACILITY_ONBOARDING.events.access(),FACILITY_ONBOARDING.events.phone(),FACILITY_ONBOARDING.events.submitSettings()},access:function(){$("#access").change(function(){var e=$(this).val();e.includes("Front")&&$("#access-front-pin").show(),e.includes("Front")||($("#access-front-pin").val(""),$("#access-front-pin").hide()),e.includes("Back")&&$("#access-back-pin").show(),e.includes("Back")||($("#access-back-pin").val(""),$("#access-back-pin").hide()),e.includes("Pixel")&&$("#access-pixel-pin").show(),e.includes("Pixel")||($("#access-pixel-pin").val(""),$("#access-pixel-pin").hide())})},phone:function(){$(".add-phone-extn").click(function(){var e=$("#PhoneExtnClone").clone();e.find("input").prop("disabled",!1),e.removeAttr("id"),e.appendTo("#phoneExtnContainer")}),$(".remove-phone-extn").click(function(){$(this).parent().remove()})},submitFile:function(){$("#submitOnboarding").click(function(){var e=new FormData($("#fileUpdateForm")[0]);$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/update",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){var n;1==e.success?(n='<div class="p-3 mb-2 bg-success text-white">'+e.message+"</div>",$("#formConfirmation").html(n),setTimeout(function(){$("#formConfirmation").html("")},5e3),$("#updateFileModal").modal("hide"),$("#files_table").DataTable().ajax.reload(),$("#fileUpdateForm")[0].reset()):(n='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',n+="<ul>",$.each(e.message,function(e,i){n+="<li>"+i+"</li>"}),n+="</ul></div>",$("#validationErrors").html(n))}})})},insertFile:function(){$("#submitAddOnboarding").click(function(){var e=new FormData($("#fileAddForm")[0]);$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/insert",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){var n;1==e.success?(n='<div class="p-3 mb-2 bg-success text-white">'+e.message+"</div>",$("#formConfirmation").html(n),setTimeout(function(){$("#formConfirmation").html("")},5e3),$("#addFileModal").modal("hide"),$("#files_table").DataTable().ajax.reload(),$("#fileAddForm")[0].reset()):(n='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',n+="<ul>",$.each(e.message,function(e,i){n+="<li>"+i+"</li>"}),n+="</ul></div>",$("#insertValidationErrors").html(n))}})})},submitSettings:function(){$("#submitOnboardingSettings").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/update_settings",type:"POST",data:$("#onboardingSettingsForm").serialize(),dataType:"json",success:function(e){var n;1==e.success?(n='<div class="p-3 mb-2 bg-success text-white">'+e.message+"</div>",$("#settingConfirmation").html(n),setTimeout(function(){$("#settingConfirmation").html("")},5e3)):(n='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',n+="<ul>",$.each(e.message,function(e,i){n+="<li>"+i+"</li>"}),n+="</ul></div>",$("#settingValidationErrors").html(n))}})})},updateFile:function(){$("#files_table").on("click",".update-onboarding",function(){var e=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/onboarding/edit",type:"POST",data:{onboardingID:e},dataType:"json",success:function(e){1==e.success&&($("#fileUpdateForm")[0].reset(),$("#updateFileModal").find("#name").val(e.onboarding.name),$("#updateFileModal").find("#description").val(e.onboarding.description),$("#updateFileModal").find("#youtube_link").val(e.onboarding.youtube_link),$("#updateFileModal").find("#command").val(e.onboarding.command),$("#onboardingID").val(e.onboarding.id),$("#updateFileModal").modal("show"))}})})}},build:{table:function(){$("#files_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/onboarding/list",type:"POST"},columns:[{data:"name"},{data:"pdf"},{data:"youtube"},{data:"action"}]})}}};$(document).ready(FACILITY_ONBOARDING.init);