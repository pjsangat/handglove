...
(new WOW).init();var FACILITY_VOTES={init:function(){$(".datepicker").datepicker({format:"yyyy-mm-dd"}),FACILITY_VOTES.build.table(),FACILITY_VOTES.events.init()},events:{init:function(){FACILITY_VOTES.events.viewUnit(),FACILITY_VOTES.events.addUnit()},addUnit:function(){$("#submitUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/votes/add",data:$("#unitAddForm").serialize(),type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitAddForm")[0].reset(),$("#addUnitModal").modal("hide")):toastr.error(a.message,a.message_header)}})})},removeUnit:function(){$("#units_table").on("click",".remove-unit",function(){})},viewUnit:function(){$("#units_table").on("click",".view-unit",function(){var a=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/votes/get",data:{unitID:a},type:"POST",dataType:"json",success:function(a){if(1==a.success){$("#voting_start_date_label").text(a.unit.start_date),$("#voting_end_date_label").text(a.unit.end_date),$("#unitDescription").text(a.unit.description);for(var t="",e=0;e<a.unit.details.length;e++)t=(t=(t=(t=(t=(t+='<div class="row mb-3">')+'<div class="col-md-12">'+'<div class="clinician-details">')+('<div class="clinician-name">'+a.unit.details[e].clinician_details.name+"</div>")+'<div class="progress">')+('<div class="progress-bar bg-warning" role="progressbar" style="width: '+a.unit.details[e].vote_percentage+'%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>'))+"</div>"+"</div>")+"</div>"+"</div>";$("#cliniciansVote").html(t),$("#unitModal").modal("show")}}})}),$("#updateUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/update",data:$("#unitUpdateForm").serialize(),type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitUpdateForm")[0].reset(),$("#unitModal").modal("hide")):toastr.error(a.message,a.message_header)}})})}},build:{table:function(){$("#units_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/votes/list",dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"description"},{data:"action"}]})}}};$(document).ready(FACILITY_VOTES.init);