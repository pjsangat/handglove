...
(new WOW).init();var FACILITY_VOTES={init:function(){$(".selectpicker").selectpicker("refresh"),FACILITY_VOTES.build.table(),FACILITY_VOTES.events.init()},events:{init:function(){FACILITY_VOTES.events.viewUnit(),FACILITY_VOTES.events.addUnit(),FACILITY_VOTES.events.removeUnit(),FACILITY_VOTES.events.toggleType()},toggleType:function(){$("#voting_type").change(function(){var e=$(this).val();e?($(".clincian-checkbox").hide(),$(".clincian-checkbox."+e).show()):$(".clincian-checkbox").hide()}),$("#addUnitModal").on("show.bs.modal",function(){$(".clincian-checkbox").hide(),$("#voting_type").val("").selectpicker("refresh")})},addUnit:function(){$("#submitUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/votes/add",data:$("#unitAddForm").serialize(),type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitAddForm")[0].reset(),$("#addUnitModal").modal("hide")):toastr.error(e.message,e.message_header)}})})},removeUnit:function(){$("#units_table").on("click",".remove-unit",function(){var e=$(this).data("id");confirm("Are you sure you want to delete this voting session? This action cannot be undone.")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/votes/delete",data:{unitID:e},type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),$("#units_table").DataTable().ajax.reload()):toastr.error(e.message,e.message_header)}})})},viewUnit:function(){$("#units_table").on("click",".view-unit",function(){var e=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/votes/get",data:{unitID:e},type:"POST",dataType:"json",success:function(e){if(1==e.success){$("#voting_start_date_label").text(e.unit.start_date),$("#voting_end_date_label").text(e.unit.end_date),$("#unitVotingType").text(e.unit.voting_type),$("#unitDescription").text(e.unit.description);for(var a="",t=0;t<e.unit.details.length;t++)a=(a=(a=(a=(a=(a+='<div class="row mb-3">')+'<div class="col-md-12">'+'<div class="clinician-details">')+('<div class="clinician-name">'+e.unit.details[t].clinician_details.name+"</div>")+'<div class="progress">')+('<div class="progress-bar bg-warning" role="progressbar" style="width: '+e.unit.details[t].vote_percentage+'%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>'))+"</div>"+"</div>")+"</div>"+"</div>";$("#cliniciansVote").html(a),$("#unitModal").modal("show")}}})}),$("#updateUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/update",data:$("#unitUpdateForm").serialize(),type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitUpdateForm")[0].reset(),$("#unitModal").modal("hide")):toastr.error(e.message,e.message_header)}})})}},build:{table:function(){$("#units_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/votes/list",dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"description"},{data:"action"}]})}}};$(document).ready(FACILITY_VOTES.init);