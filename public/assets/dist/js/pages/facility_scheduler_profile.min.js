...
var FACILITY_SCHEDULER={init:function(){FACILITY_SCHEDULER.build.calendar(),FACILITY_SCHEDULER.events()},events:function(){$("#uploadScheduleForm").on("submit",function(e){e.preventDefault(),FACILITY_SCHEDULER.build.upload()})},build:{calendar:function(){var t,e=document.getElementById("scheduler-calendar");e&&(t=(new Date).toISOString().split("T")[0],new FullCalendar.Calendar(e,{initialView:"dayGridMonth",validRange:{start:t},headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth"},themeSystem:"bootstrap",height:"auto",selectable:!0,fixedWeekCount:!1,showNonCurrentDates:!1,dayMaxEvents:!0,dateClick:function(e){new Date(e.dateStr)<new Date(t)||($("#selected-date").val(e.dateStr),$("#selected-date-display").text(e.dateStr),$("#uploadScheduleModal").modal("show"))}}).render())},upload:function(){var e=new FormData($("#uploadScheduleForm")[0]);$("#btnUploadSchedule").prop("disabled",!0).text("Uploading..."),$.ajax({url:GLOBAL_BASE_URL+"facility/upload_schedule",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){1==e.success?(toastr.success(e.message),$("#uploadScheduleModal").modal("hide"),$("#uploadScheduleForm")[0].reset()):toastr.error(e.message)},complete:function(){$("#btnUploadSchedule").prop("disabled",!1).text("Upload")}})}}};$(document).ready(FACILITY_SCHEDULER.init);