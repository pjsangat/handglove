...
(new WOW).init();var PROFILE={init:function(){PROFILE.events.init()},events:{init:function(){PROFILE.events.vote()},vote:function(){$(".vote-clinician").click(function(){var i=$(this).data("voting_id"),t=$(this).data("clinician_id");$.ajax({url:GLOBAL_BASE_URL+"facility/vote",data:{votingID:i,clinicianID:t},type:"POST",dataType:"json",success:function(i){1==i.success?(toastr.success(i.message,i.message_header),setTimeout(function(){location.reload()},2e3)):toastr.error(i.message,i.message_header)}})})}},build:{}};$(document).ready(PROFILE.init);