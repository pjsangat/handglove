...
(new WOW).init();var FACILITY_PERSONNEL={addSignaturePad:null,editSignaturePad:null,init:function(){FACILITY_PERSONNEL.build.table(),FACILITY_PERSONNEL.events.init(),FACILITY_PERSONNEL.build.signaturePads()},events:{init:function(){FACILITY_PERSONNEL.events.viewPersonnel(),FACILITY_PERSONNEL.events.addPersonnel(),FACILITY_PERSONNEL.events.signatureActions()},signatureActions:function(){$(".btn-clear").click(function(){("add-signature-pad"===$(this).closest(".signature-pad").attr("id")?FACILITY_PERSONNEL.addSignaturePad:FACILITY_PERSONNEL.editSignaturePad).clear()}),$(".btn-undo").click(function(){var e="add-signature-pad"===$(this).closest(".signature-pad").attr("id")?FACILITY_PERSONNEL.addSignaturePad:FACILITY_PERSONNEL.editSignaturePad,a=e.toData();a&&0<a.length&&(a.pop(),e.fromData(a))}),$(".signature-upload").change(function(e){var e=e.target.files[0],a=new FileReader,n=$(this).closest(".form-group"),t=n.find('input[name="signature"]'),r="add-signature-pad"===n.find(".signature-pad").attr("id")?FACILITY_PERSONNEL.addSignaturePad:FACILITY_PERSONNEL.editSignaturePad;a.onloadend=function(){t.val(a.result),r.clear()},e&&a.readAsDataURL(e)}),$("#btn-change-signature").click(function(){$("#edit-signature-preview-container").hide(),$("#edit-signature-pad").show(),$(".signature-upload-container").show(),FACILITY_PERSONNEL.editSignaturePad.clear(),$("#edit-signature-input").val("")})},addPersonnel:function(){$("#submitPersonnel").click(function(){FACILITY_PERSONNEL.addSignaturePad.isEmpty()||$("#add-signature-input").val(FACILITY_PERSONNEL.addSignaturePad.toDataURL("image/png")),$.ajax({url:GLOBAL_BASE_URL+"facility/manage/personnel/add",data:$("#personnelAddForm").serialize(),type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),$("#personnel_table").DataTable().ajax.reload(),$("#personnelAddForm")[0].reset(),$("#personnelAddForm .selectpicker").selectpicker("refresh"),FACILITY_PERSONNEL.addSignaturePad.clear(),$("#addPersonnelModal").modal("hide")):toastr.error(e.message,e.message_header)}})})},viewPersonnel:function(){$("#personnel_table").on("click",".view-personnel",function(){var e=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/personnel/get",data:{personnelID:e},type:"POST",dataType:"json",success:function(e){1==e.success&&($("#personnelID").val(e.personnel.id),$("#personnelFirstName").val(e.personnel.first_name),$("#personnelLastName").val(e.personnel.last_name),$("#personnelEmail").val(e.personnel.email),$("#personnelContact").val(e.personnel.contact_number),e.personnel.signature&&""!==e.personnel.signature?($("#edit-signature-preview").attr("src",e.personnel.signature),$("#edit-signature-preview-container").show(),$("#edit-signature-pad").hide(),$(".signature-upload-container").hide(),$("#edit-signature-input").val(e.personnel.signature)):($("#edit-signature-preview-container").hide(),$("#edit-signature-pad").show(),$(".signature-upload-container").show(),FACILITY_PERSONNEL.editSignaturePad.clear(),$("#edit-signature-input").val("")),$("#personnelType").val(e.personnel.type).selectpicker("refresh"),$("#personnelStatus").val(e.personnel.status).selectpicker("refresh"),$("#personnelModal").modal("show"))}})}),$("#updatePersonnel").click(function(){$("#edit-signature-pad").is(":visible")&&!FACILITY_PERSONNEL.editSignaturePad.isEmpty()&&$("#edit-signature-input").val(FACILITY_PERSONNEL.editSignaturePad.toDataURL("image/png")),$.ajax({url:GLOBAL_BASE_URL+"facility/manage/personnel/update",data:$("#personnelUpdateForm").serialize(),type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),$("#personnel_table").DataTable().ajax.reload(),$("#personnelUpdateForm")[0].reset(),$("#personnelUpdateForm .selectpicker").selectpicker("refresh"),$("#personnelModal").modal("hide")):toastr.error(e.message,e.message_header)}})})}},build:{signaturePads:function(){var e=document.getElementById("add-signature-pad"),e=(e&&(e=e.querySelector("canvas"),FACILITY_PERSONNEL.addSignaturePad=new SignaturePad(e,{backgroundColor:"rgb(255, 255, 255)"})),document.getElementById("edit-signature-pad"));e&&(e=e.querySelector("canvas"),FACILITY_PERSONNEL.editSignaturePad=new SignaturePad(e,{backgroundColor:"rgb(255, 255, 255)"}))},table:function(){$("#personnel_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/personnel/list",dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"email"},{data:"contact"},{data:"type"},{data:"status"},{data:"action"}]})}}};$(document).ready(FACILITY_PERSONNEL.init);