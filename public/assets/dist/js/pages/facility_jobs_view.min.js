...
var FACILITY_JOBS_VIEW={init:function(){FACILITY_JOBS_VIEW.events.init()},events:{init:function(){FACILITY_JOBS_VIEW.events.respondApplication(),FACILITY_JOBS_VIEW.events.cancelJob()},respondApplication:function(){$(".respond-request").click(function(){var e=$(this).data("shift-id"),s=$(this).data("id"),t=$(this).data("value");confirm("Are you sure you want to "+(20==t?"accept":"decline")+" this application?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/respond",data:{shiftID:e,clinicianID:s,status:t},type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),setTimeout(function(){location.reload()},2e3)):toastr.error(e.message,e.message_header)}})})},cancelJob:function(){$(".cancel-shift").click(function(){var e=$(this).data("id");confirm("Are you sure you want to cancel this shift?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/update",data:{shiftID:e,status:100},type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),setTimeout(function(){window.location.href=GLOBAL_BASE_URL+"facility/manage/jobs"},2e3)):toastr.error(e.message,e.message_header)}})})}}};$(document).ready(FACILITY_JOBS_VIEW.init);