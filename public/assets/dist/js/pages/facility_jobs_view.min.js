...
var FACILITY_JOBS_VIEW={init:function(){FACILITY_JOBS_VIEW.events.init()},events:{init:function(){FACILITY_JOBS_VIEW.events.respondApplication(),FACILITY_JOBS_VIEW.events.cancelJob()},respondApplication:function(){$(".respond-request").click(function(){var a=$(this).data("shift-id"),t=$(this).data("id"),i=$(this).data("value");confirm("Are you sure you want to "+(20==i?"accept":"decline")+" this application?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/respond",data:{shiftID:a,clinicianID:t,status:i},type:"POST",dataType:"json",success:function(a){var t;1==a.success?(t='<div class="alert alert-success">'+a.message+"</div>",$("#applicationConfirmation").html(t),setTimeout(function(){location.reload()},2e3)):(t='<div class="alert alert-danger">'+a.message+"</div>",$("#applicationConfirmation").html(t))}})})},cancelJob:function(){$(".cancel-shift").click(function(){var a=$(this).data("id");confirm("Are you sure you want to cancel this shift?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/update",data:{shiftID:a,status:100},type:"POST",dataType:"json",success:function(a){1==a.success?(alert(a.message),window.location.href=GLOBAL_BASE_URL+"facility/manage/jobs"):alert("Error: "+a.message)}})})}}};$(document).ready(FACILITY_JOBS_VIEW.init);