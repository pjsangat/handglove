...
(new WOW).init();var FACILITY_JOBS={shiftDate:{},init:function(){FACILITY_JOBS.shiftDate=$(".datepicker").datepicker({format:"yyyy-mm-dd"}),FACILITY_JOBS.build.table(),FACILITY_JOBS.events.init()},events:{init:function(){FACILITY_JOBS.events.requestClinician(),FACILITY_JOBS.events.addUnit(),FACILITY_JOBS.events.cancelJob(),FACILITY_JOBS.events.respondApplication()},addUnit:function(){$("#submitUnit").click(function(){$("#validationErrors").html(""),$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/add",data:$("#unitAddForm").serialize(),type:"POST",dataType:"json",success:function(t){var i;1==t.success?($("#unitAddForm")[0].reset(),i='<div class="p-3 mb-2 bg-success text-white">'+t.message+"</div>",$("#formConfirmation").html(i),setTimeout(function(){$("#formConfirmation").html(""),$("#formConfirmation").hide()},5e3),$("#addUnitModal").modal("hide"),$("#units_table").DataTable().ajax.reload()):(i='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',i+="<ul>",$.each(t.message,function(t,a){i+="<li>"+a+"</li>"}),i+="</ul></div>",$("#validationErrors").html(i))}})})},removeUnit:function(){$("#units_table").on("click",".remove-unit",function(){})},requestClinician:function(){$("#units_table").on("click",".request-clinician-table",function(){var t=$(this).data("id"),a=$(this).data("type");$("#clinicians_table").DataTable().destroy(),$("#clinicians_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/clinicians/list?type=request&shift="+t+"&shiftType="+a,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"status"},{data:"action"}]}),$("#unitModal").modal("show")}),$("#units_table").on("click",".view-shift",function(){var t=$(this).data("id"),a=$(this).data("type");$("#shiftDetailsDateTime").text($("#shift_view-"+t+" #shift-details-date").text()+" "+$("#shift_view-"+t+" #shift-details-time").text()),$("#shiftDetailsType").text($("#shift_view-"+t+" #shift-details-role").text()),$("#shiftDetailsUnit").text($("#shift_view-"+t+" #shift-details-unit").text()),$("#shiftDetailsSlots").text("Open: "+$("#shift_view-"+t+" #shift-details-slot").text()+" positions filled"),$("#applicantsModal .cancel-shift").attr("data-shift_id",t),$("#applicantsModal .cancel-shift").data("shift_id",t),$("#applicants_table").DataTable().destroy(),$("#applicants_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/requests_list?type=list&shift="+t+"&shiftType="+a,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"action"}]}),$("#applicantsModal").find("#shift-details-id").text("Shift # "+t),$("#applicantsModal").modal("show")}),$("#clinicians_table").on("click",".request-clinician",function(){var t=$(this).data("id"),a=$(this).data("shift-id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/request",data:{clinicianID:t,shiftID:a},type:"POST",dataType:"json",success:function(t){var i;1==t.success?(i='<div class="p-3 mb-2 bg-success text-white">'+t.message+"</div>",$("#requestConfirmation").html(i),setTimeout(function(){$("#requestConfirmation").html(""),$("#requestConfirmation").hide()},5e3),$("#clinicians_table").DataTable().ajax.reload(),$("#units_table").DataTable().ajax.reload()):(i='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',i+="<ul>",$.each(t.error,function(t,a){i+="<li>"+a+"</li>"}),i+="</ul></div>",$("#requestConfirmation").html(i),$("#requestConfirmation").show())}})}),$("#updateUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/update",data:$("#unitUpdateForm").serialize(),type:"POST",dataType:"json",success:function(t){1==t.success&&($("#units_table").DataTable().ajax.reload(),$("#unitUpdateForm")[0].reset(),$("#unitModal").modal("hide"))}})})},respondApplication:function(){$("#applicants_table").on("click",".respond-request",function(){var t=$(this).data("shift-id"),a=$(this).data("id"),i=$(this).data("value");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/respond",data:{shiftID:t,clinicianID:a,status:i},type:"POST",dataType:"json",success:function(t){var a;1==t.success?(a='<div class="p-3 mb-2 bg-success text-white">'+t.message+"</div>",$("#applicationConfirmation").html(a),setTimeout(function(){$("#applicationConfirmation").html(""),$("#applicationConfirmation").hide()},5e3),$("#applicants_table").DataTable().destroy(),$("#applicants_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/requests_list?type=list&shift="+t.shift.id+"&shiftType="+t.shift.type,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"action"}]})):(a='<div class="p-3 mb-2 bg-danger text-white">'+t.message+"</div>",$("#applicationConfirmation").html(a),setTimeout(function(){$("#applicationConfirmation").html(""),$("#applicationConfirmation").hide()},5e3))}})})},cancelJob:function(){$("#applicantsModal").on("click",".cancel-shift",function(){var t=$(this).data("shift_id");confirm("Are you sure you want to cancel this shift?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/update",data:{shiftID:t,status:100},type:"POST",dataType:"json",success:function(t){var i;1==t.success?(i='<div class="p-3 mb-2 bg-success text-white">'+t.message+"</div>",$("#formConfirmation").html(i),setTimeout(function(){$("#formConfirmation").html(""),$("#formConfirmation").hide()},5e3),$("#applicantsModal").modal("hide"),$("#units_table").DataTable().ajax.reload()):(i='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',i+="<ul>",$.each(t.message,function(t,a){i+="<li>"+a+"</li>"}),i+="</ul></div>",$("#validationErrors").html(i))}})})}},build:{table:function(){$("#units_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/list",data:function(t){t.date=$("#shiftDate").val(),t.time=$("#shiftTime").val()},dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"action"}]}),FACILITY_JOBS.shiftDate.on("changeDate",function(t){$("#units_table").DataTable().ajax.reload()}),$("#shiftTime").change(function(){$("#units_table").DataTable().ajax.reload()})}}};$(document).ready(FACILITY_JOBS.init);