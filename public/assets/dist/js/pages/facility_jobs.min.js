...
(new WOW).init();var FACILITY_JOBS={shiftDate:{},init:function(){FACILITY_JOBS.shiftDate=$(".datepicker").datepicker({format:"yyyy-mm-dd"}),FACILITY_JOBS.build.table(),FACILITY_JOBS.events.init()},events:{init:function(){FACILITY_JOBS.events.requestClinician(),FACILITY_JOBS.events.addUnit(),FACILITY_JOBS.events.cancelJob(),FACILITY_JOBS.events.respondApplication()},addUnit:function(){$("#submitUnit").click(function(){$("#validationErrors").html(""),$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/add",data:$("#unitAddForm").serialize(),type:"POST",dataType:"json",success:function(a){var e;1==a.success?(toastr.success(a.message,a.message_header),$("#unitAddForm")[0].reset(),$("#addUnitModal").modal("hide"),$("#units_table").DataTable().ajax.reload()):(e='<div class="p-3 mb-2 bg-danger text-white">Please see the following errors below:',e+="<ul>",$.each(a.message,function(a,t){e+="<li>"+t+"</li>"}),e+="</ul></div>",$("#validationErrors").html(e),toastr.error("Validation failed. Please check the errors below.",a.message_header))}})})},removeUnit:function(){$("#units_table").on("click",".remove-unit",function(){})},requestClinician:function(){$("#units_table").on("click",".request-clinician-table",function(){var a=$(this).data("id"),t=$(this).data("type");$("#clinicians_table").DataTable().destroy(),$("#clinicians_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/clinicians/list?type=request&shift="+a+"&shiftType="+t,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"status"},{data:"action"}]}),$("#unitModal").modal("show")}),$("#units_table").on("click",".view-shift",function(){var a=$(this).data("id"),t=$(this).data("type");$("#shiftDetailsDateTime").text($("#shift_view-"+a+" #shift-details-date").text()+" "+$("#shift_view-"+a+" #shift-details-time").text()),$("#shiftDetailsType").text($("#shift_view-"+a+" #shift-details-role").text()),$("#shiftDetailsUnit").text($("#shift_view-"+a+" #shift-details-unit").text()),$("#shiftDetailsSlots").text("Open: "+$("#shift_view-"+a+" #shift-details-slot").text()+" positions filled"),$("#applicantsModal .cancel-shift").attr("data-shift_id",a),$("#applicantsModal .cancel-shift").data("shift_id",a),$("#applicants_table").DataTable().destroy(),$("#applicants_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/requests_list?type=list&shift="+a+"&shiftType="+t,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"action"}]}),$("#applicantsModal").find("#shift-details-id").text("Shift # "+a),$("#applicantsModal").modal("show")}),$("#clinicians_table").on("click",".request-clinician",function(){var a=$(this).data("id"),t=$(this).data("shift-id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/request",data:{clinicianID:a,shiftID:t},type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#clinicians_table").DataTable().ajax.reload(),$("#units_table").DataTable().ajax.reload()):toastr.error(a.message,a.message_header)}})}),$("#updateUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/update",data:$("#unitUpdateForm").serialize(),type:"POST",dataType:"json",success:function(a){1==a.success&&($("#units_table").DataTable().ajax.reload(),$("#unitUpdateForm")[0].reset(),$("#unitModal").modal("hide"))}})})},respondApplication:function(){$("#applicants_table").on("click",".respond-request",function(){var a=$(this).data("shift-id"),t=$(this).data("id"),e=$(this).data("value");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/respond",data:{shiftID:a,clinicianID:t,status:e},type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#applicants_table").DataTable().destroy(),$("#applicants_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/requests_list?type=list&shift="+a.shift.id+"&shiftType="+a.shift.type,dataSrc:"data",type:"POST"},columns:[{data:"details"},{data:"type"},{data:"level"},{data:"action"}]})):toastr.error(a.message,a.message_header)}})})},cancelJob:function(){$("#applicantsModal").on("click",".cancel-shift",function(){var a=$(this).data("shift_id");confirm("Are you sure you want to cancel this shift?")&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/jobs/update",data:{shiftID:a,status:100},type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#applicantsModal").modal("hide"),$("#units_table").DataTable().ajax.reload()):toastr.error(a.message,a.message_header)}})})}},build:{table:function(){$("#units_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/jobs/list",data:function(a){a.date=$("#shiftDate").val(),a.time=$("#shiftTime").val()},dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"action"}]}),FACILITY_JOBS.shiftDate.on("changeDate",function(a){$("#units_table").DataTable().ajax.reload()}),$("#shiftTime").change(function(){$("#units_table").DataTable().ajax.reload()})}}};$(document).ready(FACILITY_JOBS.init);