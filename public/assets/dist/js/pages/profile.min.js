...
(new WOW).init();var PROFILE={init:function(){PROFILE.events.uploadFile(),PROFILE.events.cancelFile(),PROFILE.events.availabilityChange(),PROFILE.events.submitFile(),PROFILE.events.requestResponse(),$("#requests_table").DataTable({searching:!1,lengthChange:!1,ordering:!1}),$(".datepicker").datepicker({format:"yyyy-mm-dd"})},events:{availabilityChange:function(){$(".selectpicker").change(function(){-1!==$.inArray("I'm flexible",$(this).val(),0)?($(this).find('[value!="I\'m flexible"]').prop("selected",!1),$(this).find('[value!="I\'m flexible"]').prop("disabled",!0)):-1!==$.inArray("Not Available",$(this).val(),0)?($(this).find('[value!="Not Available"]').prop("selected",!1),$(this).find('[value!="Not Available"]').prop("disabled",!0)):$(this).find("option").prop("disabled",!1),$("#"+$(this).attr("id")).selectpicker("refresh")})},uploadFile:function(){$(".uploadFile").click(function(){$(this).parent().parent().parent().find("#fileName"+$(this).data("id")).hide(),$(this).parent().parent().parent().find("#fileUploaded"+$(this).data("id")).hide(),$(this).parent().parent().parent().find("#formCredential"+$(this).data("id")).show(),$(this).parent().hide(),$(this).parent().parent().find(".submitFileUpload").show()})},cancelFile:function(){$(".cancelFile").click(function(){0<$(this).parent().parent().parent().find("#fileUploaded"+$(this).data("id")).length&&$(this).parent().parent().parent().find("#fileName"+$(this).data("id")).show(),$(this).parent().parent().parent().find("#fileUploaded"+$(this).data("id")).show(),$(this).parent().parent().parent().find("#fileUploadError"+$(this).data("id")+".error").hide(),$(this).parent().parent().parent().find("#formCredential"+$(this).data("id")).hide(),$(this).parent().hide(),$(this).parent().parent().find(".uploadFileUpload").show()})},submitFile:function(){$(".submitFile").click(function(){var e=new FormData($("#formCredential"+$(this).data("id"))[0]),t=($("#progress"+$(this).data("id")).show(),$("#formCredential"+$(this).data("id")).hide(),$(this));$.ajax({url:GLOBAL_BASE_URL+"profile/upload_credentials",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){console.info(e),console.info(1==e.success),1==e.success?($("#formCredential"+e.data.credential_id)[0].reset(),$("#progress"+e.data.credential_id).hide(),$("#formCredential"+e.data.credential_id).hide(),$('<div id="fileUploaded'+e.data.credential_id+'">'+e.data.file+"</div>").insertBefore("#formCredential"+e.data.credential_id),$("#row"+e.data.credential_id).attr("style","background: #c1f0c1"),t.parent().parent().find(".uploadFileUpload").show(),t.parent().hide()):(t.parent().parent().find(".uploadFileUpload").show(),t.parent().hide(),$("#progress"+t.data("id")).hide(),jQuery("#fileUploadError"+t.data("id")+".error").remove(),$('<div id="fileUploadError'+t.data("id")+'" class="error" style="color: red;">'+e.message+"</div>").insertBefore("#formCredential"+t.data("id")))}})})},requestResponse:function(){$("#requests_table").on("click",".accept_request",function(){var e=$(this).data("request-id"),t=$(this).data("shift-id"),i=$(this).data("client-id");$.ajax({url:GLOBAL_BASE_URL+"profile/request",data:{requestID:e,shiftID:t,clientID:i,status:20},type:"POST",dataType:"json",success:function(e){setTimeout(function(){location.reload()},100)}})}),$("#requests_table").on("click",".decline_request",function(){var e=$(this).data("request-id"),t=$(this).data("shift-id");$.ajax({url:GLOBAL_BASE_URL+"profile/request",data:{requestID:e,shiftID:t,status:100},type:"POST",dataType:"json",success:function(e){setTimeout(function(){location.reload()},100)}})})}}};$(document).ready(PROFILE.init);